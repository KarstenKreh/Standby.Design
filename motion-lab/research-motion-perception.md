# Recherche: Wahrnehmung von Bewegung

Stand: 26.09.2026. Frage: Lassen sich die Eingaben des Motion-Tools (Tempo und Federung einer Feder) und die Zuordnung zu Marken-Charakteren auf replizierte Forschung stützen?

Kurzfassung: Die Achse **Tempo** ist gut belegt (Tempo bildet Erregung ab). Die Achse **Federung** ist als Gefühl kaum belegt, Nachschwingen wird eher als Material (weich, elastisch) gelesen.

## (a) Gut belegt

- **Tempo bildet Erregung (Arousal) ab: schnell wirkt energisch, langsam wirkt ruhig.** Robustester Befund im Feld, unabhängig in vielen Bereichen:
...
- **Valenz (angenehm ↔ unangenehm) hängt nicht an einer einzelnen Größe.** Sie entsteht aus Wechselwirkungen, z. B. Beschleunigung × Krümmung (Saerbeck) oder Rhythmus und Zackigkeit (Sievers). Eine Regel „Federung = Freundlichkeit“ gibt die Forschung nicht her.
- **Slow-in/Slow-out hilft beim Verfolgen von Objekten** (Dragicevic 2011, N=12, Einzelbefund). Passt zur Motorik-Forschung: natürliche Bewegungen haben ein glockenförmiges Geschwindigkeitsprofil (Flash & Hogan 1985).
...
- **Langsamkeit wirkt luxuriös** (Jung & Dubois 2023, JMR, 12 Experimente, N=27.227, fünf vorregistriert). Stärkste Brücke zur Markenwahrnehmung. Getestet wurde Zeitlupe in Werbevideos, nicht UI-Animation.

## (b) Plausibel, aber schwach belegt

- **Konkrete UI-Dauern (200–500 ms):** keine replizierte Studie. Einzelstudien: Huhtala 2010 (früher Beginn wirkt schneller), Ge et al. 2024 (Verzögerung nach dem Klick und Ladezeit bestimmen die Flüssigkeit stärker als die Animationsdauer), Ding & Kyung 2025 (JCR: bei Wartezeit-Animationen wirkt mittlere Geschwindigkeit am kürzesten).
...
- **Overshoot und Bounce:** Menschen lesen aus einem springenden Ball ab, wie elastisch er ist (Warren 1987). Bounce wird als Material wahrgenommen. Eine Studie, die Dämpfung gezielt verändert und Adjektive wie „verspielt“ misst, wurde nicht gefunden.
- **Studien von 2026** (Displays; IJHCI mit PAD-Emotionsmodell) verbinden Übergangsarten mit Emotionen. Nur per Abstract geprüft, Einzelstudien.

## (c) Folklore oder Branchen-Richtlinie
...
- „Dauer wächst mit der Distanz“ ist eine Richtlinie in Anlehnung an Fitts' Gesetz. Fitts misst Zielbewegungen, nicht Animationsdauern. Technisch: Eine lineare Feder braucht bei gleicher Steifigkeit gleich lange, egal wie weit sie läuft.

## (d) Folgerung für Standby Design

- Achse 1 heißt **„Energie: ruhig ↔ lebhaft“** (Tempo der Feder) und nennt die Forschung zu Tempo und Erregung offen als Grundlage.
- Achse 2 heißt **„Material: fest ↔ elastisch“** (Nachschwingen). Sie wird ausdrücklich als Design-Konvention gekennzeichnet.
...
- Formulierung für die App: „Tempo folgt gut belegter Forschung zur Wahrnehmung von Energie in Bewegung. Die Federung und die Zuordnung zu Marken sind Designkonventionen. Die Werte sind Startpunkte, kein Beweis.“
- Harte Grenze: Rückmeldung auf eine Eingabe unter 100 ms. Obergrenzen für Dauern nur als Richtlinie.
